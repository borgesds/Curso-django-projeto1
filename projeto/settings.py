...
SECRET_KEY = 'django-insecure-#0ipmnl6=-esqi@0mfc%a74(n4h7ubfr_xqi(dmpzpyjn&^$qf'
...
TEMPLATES = [
    {
        ...
        # Aqui é onde podemos colocar novas pastas templates
...
"""
# Criar uma pasta que vai salvar as fotos do projeto
MEDIA_URL = '/media/'
